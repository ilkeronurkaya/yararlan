...
const translations: Record<SupportedLang, Record<string, string>> = {
  tr: {
    ...
    'search_placeholder': 'Bugün ne yapmak istiyorsun? (Logo tasarla, reels yap, kod yaz...)',
    'search_button': 'Bul',
    'directory': 'DİZİN',
    'category_title': 'Tüm Araçlar',
    'featured_title': 'Haftanın Seçkisi',
    'recommended_title': 'Önerilenler',
    ...
    'hero_title_1': 'Türkiye’nin En Güncel Yapay Zeka ',
    'hero_title_2': 'Araç Rehberi.',
    'hero_subtitle': 'Para kazanmak, içerik üretmek, kod yazmak ve işini büyütmek için en iyi AI araçlarını keşfet.',
    ...
    'Araştırma & Analiz': 'Araştırma & Analiz',
    'Kod & Geliştirme': 'Kod & Geliştirme',
    'Veri & Dashboard': 'Veri & Dashboard',
    'Pazarlama & Growth': 'Pazarlama & Growth',
    'Otomasyon & Agent': 'Otomasyon & Agent',
    'Ses & Müzik': 'Ses & Müzik',
    'Sunum & Doküman': 'Sunum & Doküman',
  },
  en: {
    'purpose': 'Purpose',
    ...
    'search_placeholder': 'What do you want to do today? (Design a logo, write code...)',
    'search_button': 'Find',
    'directory': 'DIRECTORY',
    ...
    'hero_title_1': 'Turkey’s Most Updated AI ',
    'hero_title_2': 'Tool Directory.',
    'hero_subtitle': 'Discover the best AI tools to make money, create content, write code, and grow your business.',
    ...
    'Kod & Geliştirme': 'Code & Dev',
    'Veri & Dashboard': 'Data & Dashboard',
    'Pazarlama & Growth': 'Marketing & Growth',
    'Otomasyon & Agent': 'Automation & Agent',
    'Ses & Müzik': 'Audio & Music',
    'Sunum & Doküman': 'Presentation/Doc',
  },
  es: {
    'purpose': 'Propósito',
    ...
    'İçerik Üretimi': 'Creación Contenido',
    'Video & Reels': 'Video & Reels',
    'Görsel/Tasarım': 'Visual/Diseño',
    'Araştırma & Analiz': 'Investigación',
    'Kod & Geliştirme': 'Código y Desarrollo',
    'Veri & Dashboard': 'Datos y Dashboard',
    'Pazarlama & Growth': 'Marketing & Growth',
    'Otomasyon & Agent': 'Automatización',
    'Ses & Müzik': 'Audio y Música',
    'Sunum & Doküman': 'Presentación/Doc',
  },
  zh: {
    'purpose': '目的',
    'total_clicks': '总点击量',
    ...
    'İçerik Üretimi': '内容创作',
    'Video & Reels': '视频和短卷',
    'Görsel/Tasarım': '视觉/设计',
    'Araştırma & Analiz': '研究与分析',
    'Kod & Geliştirme': '代码与开发',
    'Veri & Dashboard': '数据与仪表盘',
    'Pazarlama & Growth': '营销与增长',
    'Otomasyon & Agent': '自动化与代理',
    'Ses & Müzik': '音频与音乐',
    'Sunum & Doküman': '演示与文档',
  }
};
