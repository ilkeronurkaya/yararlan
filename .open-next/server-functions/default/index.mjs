...
var BuildId = "L6Bd60RvsYhPsZft6vPwK";
var HtmlPages = ["/404"];
...
var AppPathRoutesManifest = { "/robots.txt/route": "/robots.txt", "/sitemap.xml/route": "/sitemap.xml", "/icon/route": "/icon", "/_not-found/page": "/_not-found", "/page": "/" };
